<script lang="ts">
  import type { MilitaryAircraft } from './military-aircraft';

  interface Props {
    plane: MilitaryAircraft;
    correct: boolean;
...
<div class="reveal" class:correct class:wrong={!correct}>
  ...
  <div class="step">
    ...
    <div class="step-body">
      <strong>Built by {plane.manufacturer} ({plane.origin})</strong>
  ...
  <div class="step">
    ...
    <div class="step-body">
      <strong>{plane.role} · {plane.engines}× engine · {plane.wings} · {plane.speed}</strong>
  ...
  <div class="step">
    ...
    <div class="step-body">
      <strong>Service entry: {plane.introduction}</strong>
...
<style>
  ...
  .tell p { font-size: 0.8125rem; line-height: 1.4; color: var(--text); }
</style>
